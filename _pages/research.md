...
We are building robotic instruments to set up a network of root observatories. We will use AI for image analysis to gather data on root phenology. We will use this to try and get a general understanding of root growth to use to improve future climate models. 
...
**RootCheck"**.
In RootCheck we are build tools to improve root health assessment in agricultural systems. 
